...
from ..config import N_SES, FP_SIZE, WV_SIZE
...
def run_model(fold, hyperparams, n_epochs=100, display_epoch_info=True):  
    ...
    model = MLP(layers=[(FP_SIZE, 1500), (1500, 1000), (1000, WV_SIZE), (WV_SIZE, WV_SIZE)], activation=None)
    model2 = MLP(layers=[(FP_SIZE+WV_SIZE, 1500), (1500, 1000), (1000, N_SES)], activation="sigmoid")
    ...
    def train(loader):
        ...
        for data in loader:  # Iterate in batches over the training dataset.
            ...
            se_embeds = y @ se_embed_mat
            loss1_1 = loss_fn_1(out1, se_embeds)
            loss1_2 = wass_loss_1(out1, se_embeds)
